...
import { columnToLabel, labelToColumn } from "@/lib/nango/google-sheets/utils";
...
export const findSheetRow = async ({
  sheetId, spreadsheetId, connectionId, startingRow, numberOfRows, matchCase, columnName: cn, searchValue: sv
}: FindSheetRowParams) => {
